#!/usr/bin/env python3
"""Freeze compact spectral survival and kill gates."""
...
OUT = ROOT / "evidence/p_taucov_compact_spectral_survival_kill_gates.csv"
SUMMARY = ROOT / "evidence/p_taucov_compact_spectral_survival_kill_gates_summary.csv"
DOC = ROOT / "docs/p_taucov_compact_spectral_survival_kill_gates.md"

PROTOCOL_ID = "P_TAUCOV_BRANCH_LOCALIZED_COVARIANCE_RESPONSE_v1"
FREEZE_ID = "P_TAUCOV_COMPACT_SPECTRAL_SURVIVAL_KILL_GATES_FREEZE_v1"
CLAIM_BOUNDARY = "compact_spectral_survival_kill_gates_freeze_no_scoring"
...
def main() -> int:
        ...
        [
            {
                "ProtocolID": PROTOCOL_ID,
                "FreezeID": FREEZE_ID,
                "Status": "P_TAUCOV_COMPACT_SPECTRAL_SURVIVAL_KILL_GATES_FROZEN_NO_SCORING",
    ...
    DOC.write_text(
        """# P-TauCov Compact Spectral Survival/Kill Gates
...
alpha stability, and the declared information-criterion pass. These gates do
not authorize scoring.
""",
        encoding="utf-8",
    )
    print("P_TAUCOV_COMPACT_SPECTRAL_SURVIVAL_KILL_GATES_FROZEN_NO_SCORING")
    return 0
